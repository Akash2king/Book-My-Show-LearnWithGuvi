...
async function fetchMovieDetails(movieId) {
  try {
    ...
    if (response.ok) {
            ...
            <div class="row">
              <div class="col-md-4">
                <img
                  ...
                  style="max-width: 100%; height: 100%; object-fit: cover ; border: white solid 1px; "
                />
              </div>
              <div class="col-md-8">
                <div style="color: white; padding: 0px;">
                  <h1 class="mb-4" >${movie.title}</h1>
                  <h4 class="mb-4"  style=" color:grey;">Director : ${movie.director}</h4>
                  <h4 class="mb-4"  style=" color:grey;">Genre : ${movie.genre}</h4>
                  <h2>About the movie</h2>
                  <p style=" color:grey;">${movie.description}</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <h2 class="mt-4 mb-4 text-center bg-light">Book Tickets</h2>`;
